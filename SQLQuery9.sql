...
-- =========================================================
-- ลบตารางเดิมถ้ามีอยู่ (เรียงลำดับตาม FK dependencies)
-- =========================================================
DROP TABLE IF EXISTS FeedingSchedule;
DROP TABLE IF EXISTS EnclosureKeeper;
DROP TABLE IF EXISTS Animal;
DROP TABLE IF EXISTS Food;
DROP TABLE IF EXISTS Keeper;
DROP TABLE IF EXISTS Enclosure;
DROP TABLE IF EXISTS SpeciesInfo;
...
-- =========================================================
-- ตาราง EnclosureKeeper (M:N Relation)
-- =========================================================
